...
$secret_object = mysqli_query($connection, "SELECT secret FROM login_information WHERE username = '".$input_username."' AND password = '".$password."' or die(mysql_error($connection));
